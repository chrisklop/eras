...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cost: { grain: 800 },
    era: 'agrarian',
    requires: s => !!s.completedProjects.pottery && (s.upgrades.dwelling ?? 0) >= 8,
    requirementsText: 'Requires Pottery, 8 dwellings',
  ...
  },
  {
    ...
    cost: { grain: 6000 },
    era: 'agrarian',
    requires: s => !!s.completedProjects.masonry && (s.upgrades.dwelling ?? 0) >= 20,
    requirementsText: 'Requires Masonry, 20 dwellings',
  ...
  },
  {
    ...
    cost: { output: 2000 },
    era: 'industrial',
    requires: s => s.era === 'industrial' && (s.upgrades.factory ?? 0) >= 6,
    requirementsText: 'Requires 6 factories',
  ...
  },
  {
    ...
    cost: { output: 50000 },
    era: 'industrial',
    requires: s => s.era === 'industrial' && !!s.completedProjects.massProduction && (s.upgrades.factory ?? 0) >= 20,
    requirementsText: 'Requires Mass Production, 20 factories',
  ...
  },
  {
    ...
    cost: { output: 15000 },
    era: 'industrial',
    requires: s => s.era === 'industrial' && (s.upgrades.factory ?? 0) >= 8 && (s.upgrades.dwelling ?? 0) >= 30,
    requirementsText: 'Requires 8 factories, 30 dwellings',
  ...
  },
  {
    ...
    cost: { output: 150000 },
    era: 'industrial',
    requires: s => !!s.completedProjects.electricity && (s.upgrades.dwelling ?? 0) >= 50,
    requirementsText: 'Requires Electricity, 50 dwellings',
